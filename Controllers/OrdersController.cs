	...
	public class OrdersController : ControllerBase
	{
		...
		public IActionResult GetOrders([FromBody] GetOrderFilter filter)
		{
			...
			var result = db.Orders
				.Where(e => !e.IsDeleted && e.CreateDate >= filter.Date && e.CreateDate < filter.Date.AddDays(1))
				.Select(e => new Order
				{
					Id = e.Id,
					...
					{
						Id = e.Status.Id,
						IsDeleted = e.Status.IsDeleted,
						Description = e.Status.Description,
						Name = e.Status.Name,
						NextStatus = e.Status.NextStatus,
						NextStatusId = e.Status.NextStatusId
					},
					User = new User
					{
						UserName = e.UserName,
